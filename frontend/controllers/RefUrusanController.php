...
use frontend\models\RefUrusanSearch;
...
class RefUrusanController extends Controller
{
    ...
    public function actionCreate()
    {
        $request = Yii::$app->request;
        $model = new RefUrusan();
        $model->tahun = RefUrusan::find()->max('tahun') + 1;
        $model->kd_urusan = RefUrusan::find()->max('kd_urusan') + 1;
        ...
        if($request->isAjax){
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->kd_urusan]);
            } else {
    ...
    /**
     * Updates an existing RefUrusan model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing RefUrusan model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefUrusan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = RefUrusan::findOne($id)) !== null) {
            return $model;
        } 
